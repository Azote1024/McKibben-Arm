...
// 使う人工筋の設定(UI)
#define PIN_P_SENSOR_IN A0
#define PIN_INTAKE_IN 2
#define PIN_EXHAUST_IN 3

// 使う人工筋の設定(UO)
#define PIN_P_SENSOR_OUT A1
#define PIN_INTAKE_OUT 8
#define PIN_EXHAUST_OUT 9
...
//  p_target_out = 150.0;
  ...
  time_width_in = calcTimeWidth(p_current_in, p_target_in, v_current_in, PIPE_U);

  // out側時間幅
  p_current_out = getPressure(PIN_P_SENSOR_OUT);
  v_current_out = calcVolumeFree(p_current_out);
  time_width_out = calcTimeWidth(p_current_out, p_target_out, v_current_out, PIPE_U);
